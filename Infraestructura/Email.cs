...
namespace Infraestructura
{
    public class Email
    {
        ...
        private void ConfigurarSmt()
        {
            ...
            smtp.Credentials = new System.Net.NetworkCredential("rafaelricardo1435@gmail.com", "ricardo123");
        }

        public void ConfigurarEmail(Persona persona )
        {

            email = new MailMessage();
            email.To.Add(persona.Email);
            email.From = new MailAddress(persona.Email);
            email.Subject = "Rafael Caceres - Registro de Usuario "
